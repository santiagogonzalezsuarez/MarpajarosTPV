...
QT_MOC_LITERAL(1, 9, 15), // "successfulLogin"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 5), // "login"
QT_MOC_LITERAL(4, 32, 7) // "doLogin"

    },
    "frmLogin\0successfulLogin\0\0login\0doLogin"
};
...
void frmLogin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->successfulLogin((*reinterpret_cast< QJsonObject(*)>(_a[1]))); break;
        ...
        {
            using _t = void (frmLogin::*)(QJsonObject );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&frmLogin::successfulLogin)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void frmLogin::successfulLogin(QJsonObject _t1)
{
